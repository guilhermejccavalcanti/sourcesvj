...
import static de.fosd.jdime.config.CommandLineConfigSource.CLI_OPTIMIZE_MULTI_CONFLICTS;
...
import jdime.fpfn.ASTBranchesResult;
...
public class MergeContext implements Cloneable {
	...
	//FPFN
	public List<Difference> differences = new ArrayList<Difference>();
	public List<ASTNodeArtifact> samePstCandidates = new ArrayList<ASTNodeArtifact>();
	public ASTBranchesResult editedBranches = new ASTBranchesResult();
	public String mergedFiles;
	public long mergeCalls = 0L;
	public long unorderedMergeCalls = 0L;
	public List<FixedMergeConflict> mergeConflictsToFix = new ArrayList<>();
