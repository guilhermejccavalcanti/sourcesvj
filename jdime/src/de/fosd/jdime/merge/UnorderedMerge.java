...
public class UnorderedMerge<T extends Artifact<T>> implements MergeInterface<T> {
	...
	public void merge(MergeOperation<T> operation, MergeContext context) {
		...
		while (!leftdone || !rightdone) {
			...
			//FPFN avoiding infinite loops
			if(context.unorderedMergeCalls > 10000000){	throw new RuntimeException("JDime infinite loop at unordered merge.");
			} else {context.unorderedMergeCalls++;}
