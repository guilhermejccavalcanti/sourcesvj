...
public class JavaBeanDeserializer implements ObjectDeserializer {
  ...
  public  <T extends java.lang.Object> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
    return deserialze(parser, type, fieldName, 0);
  }
  public  <T extends java.lang.Object> T deserialze(DefaultJSONParser parser, Type type, Object fieldName, int features) {
    return deserialze(parser, type, fieldName, null, features, null);
  }
  @SuppressWarnings(value = {"unchecked", }) public  <T extends java.lang.Object> T deserialzeArrayMapping(DefaultJSONParser parser, Type type, Object fieldName, Object object) {
              ...
              if (fieldClass == boolean.class) {
                ...
                if (fieldClass == float.class) {
                  ...
                  if (fieldClass == double.class) {
                    ...
                    if (fieldClass == java.util.Date.class && lexer.getCurrent() == '1') {
  ...
  @SuppressWarnings(value = {"unchecked", "rawtypes", }) protected  <T extends java.lang.Object> T deserialze(DefaultJSONParser parser, Type type, Object fieldName, Object object, int features, int[] setFlags) {
...
>>>>>>> C:\Users\user\Desktop\gjcc\amostra\projects\fastjson\revisions\rev_c76d44b_a12ff69\rev_right_a12ff69\src\main\java\com\alibaba\fastjson\parser\deserializer\JavaBeanDeserializer.java
  ...
  public FieldDeserializer smartMatch(String key) {
    ...
    if (fieldDeserializer == null) {
      ...
      for (FieldDeserializer fieldDeser : sortedFieldDeserializers) {
        ...
        if (startsWithIs && (fieldClass == boolean.class || fieldClass == Boolean.class) && fieldName.equalsIgnoreCase(key.substring(2))) {
          fieldDeserializer = fieldDeser;
          break ;
        }
      }
  ...
  @SuppressWarnings(value = {"unchecked", "rawtypes", }) protected static void parseArray(Collection collection, ObjectDeserializer deser, DefaultJSONParser parser, Type type, Object fieldName) {
    final JSONLexerBase lexer = (JSONLexerBase)parser.lexer;
    int token = lexer.token();
    if (token == JSONToken.NULL) {
      lexer.nextToken(JSONToken.COMMA);
