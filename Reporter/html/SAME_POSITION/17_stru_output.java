...
@RunWith(value = RobolectricTestRunner.class) @Config(manifest = Config.NONE, emulateSdk = 18) public class ImageHeaderParserTest {
  ...
  @Test public void testCanParsePngType() throws IOException {
  ...
  @Test public void testCanParsePngWithAlpha() throws IOException {
    for (int i = 3; i <= 6; i++) {
  ...
  @Test public void testCanParsePngWithoutAlpha() throws IOException {
    for (int i = 0; i < 3; i++) {
      byte[] pngHeaderWithIhdrChunk = generatePngHeaderWithIhdr(i);
      runTest(pngHeaderWithIhdrChunk, new ParserTestCase() {
          @Override public void run(ImageHeaderParser parser) throws IOException {
  ...
  @Test public void testCanParseJpegType() throws IOException {
  ...
  @Test public void testCanParseGifType() throws IOException {
  ...
  @Test public void testReturnsUnknownTypeForUnknownImageHeaders() throws IOException {
  ...
  @Test public void testReturnsUnknownTypeForEmptyData() throws IOException {
    InputStream is = new ByteArrayInputStream(new byte[0]);
    ImageHeaderParser parser = new ImageHeaderParser(is);
    assertEquals(ImageType.UNKNOWN, parser.getType());
  }
  @Test public void testHandlesParsingOrientationWithMinimalExifSegment() throws IOException {
  ...
  @Test public void testReturnsUnknownForEmptyData() throws IOException {
  ...
  @Test public void testHandlesPartialReads() throws IOException {
  ...
  @Test public void testHandlesPartialSkips() throws IOException {
    InputStream is = TestResourceUtil.openResource(getClass(), "issue387_rotated_jpeg.jpg");
    ImageHeaderParser parser = new ImageHeaderParser(new PartialSkipInputStream(is), byteArrayPool);
    assertThat(parser.getOrientation()).isEqualTo(6);
  }
  @Test public void testHandlesSometimesZeroSkips() throws IOException {
