...
public class RecordReaderImpl implements RecordReader {
  ...
  static TruthValue evaluatePredicate(ColumnStatistics stats, PredicateLeaf predicate, BloomFilterIO bloomFilter) {
  ...
  static TruthValue evaluatePredicateRange(PredicateLeaf predicate, Object min, Object max, boolean hasNull, BloomFilterIO bloomFilter) {
    if (min == null) {
  ...
  private static TruthValue evaluatePredicateBloomFilter(PredicateLeaf predicate, final Object predObj, BloomFilterIO bloomFilter, boolean hasNull) {
    switch (predicate.getOperator()){
      case NULL_SAFE_EQUALS:
...
>>>>>>> C:\Users\user\Desktop\gjcc\amostra\projects\hive\revisions\rev_4f097fd_88482c3\rev_right_88482c3\ql\src\java\org\apache\hadoop\hive\ql\io\orc\RecordReaderImpl.java
  ...
  private void clearStreams() throws IOException {
    ...
    if (bufferChunks != null) {
      if (zcr != null) {
        for (Unknown range = bufferChunks; range != null; range = range.next) {
  ...
  public static class BufferChunk extends DiskRangeList {
    ...
    @Override public DiskRange sliceAndShift(long offset, long end, long shiftBy) {
  ...
  void createStreams(List<OrcProto.Stream> streamDescriptions, DiskRangeList ranges, boolean[] includeColumn, CompressionCodec codec, int bufferSize, Map<StreamName, InStream> streams) throws IOException {
    ...
    for (OrcProto.Stream streamDesc : streamDescriptions) {
      ...
      streams.put(name, InStream.create(null, name.toString(), buffers, streamDesc.getLength(), codec, bufferSize, null));
      streamOffset += streamDesc.getLength();
    }
  }
