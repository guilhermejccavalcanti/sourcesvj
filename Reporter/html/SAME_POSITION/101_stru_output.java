...
public class PatchFixes {
  ...
  @java.lang.SuppressWarnings(value = {"unchecked", "rawtypes", }) public static java.util.List removeGeneratedNodes(java.util.List list) {
    try {
...
>>>>>>> C:\Users\user\Desktop\gjcc\amostra\projects\lombok\revisions\rev_3027618_bf354e3\rev_right_bf354e3\src\eclipseAgent\lombok\eclipse\agent\PatchFixes.java
  ...
  public static void setIsGeneratedFlag(org.eclipse.jdt.core.dom.ASTNode domNode, org.eclipse.jdt.internal.compiler.ast.ASTNode internalNode) throws Exception {
  ...
  public static RewriteEvent[] listRewriteHandleGeneratedMethods(RewriteEvent parent) {
    ...
    for (int i = 0; i < children.length; i++) {
      ...
      if (isGenerated) {
        if ((child.getChangeKind() == RewriteEvent.REPLACED || child.getChangeKind() == RewriteEvent.REMOVED) && child.getOriginalValue() instanceof org.eclipse.jdt.core.dom.MethodDeclaration && child.getNewValue() != null) {
