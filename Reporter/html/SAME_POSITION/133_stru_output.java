...
@RunWith(value = RobolectricTestRunner.class) @Config(manifest = Config.NONE, emulateSdk = 18) public class VideoBitmapDecoderTest {
...
>>>>>>> C:\Users\user\Desktop\gjcc\amostra\projects\glide\revisions\rev_f389e91_431ccaf\rev_right_431ccaf\library\src\androidTest\java\com\bumptech\glide\load\resource\bitmap\VideoBitmapDecoderTest.java
  ...
  @Test public void testReturnsRetrievedFrameForResource() throws IOException {
  ...
  @Test public void testReleasesMediaMetadataRetriever() throws IOException {
    decoder.decode(resource, bitmapPool, 1, 2, options);
    verify(retriever).release();
  }
  @Test public void testClosesResource() throws IOException {
    decoder.decode(resource, bitmapPool, 1, 2, options);
    verify(resource).close();
  }
  @Test public void testHasValidId() {
    Util.assertClassHasValidId(VideoBitmapDecoder.class, decoder.getId());
  }
  @Test(expected = IllegalArgumentException.class) public void testThrowsExceptionIfCalledWithInvalidFrame() throws IOException {
    options.put(VideoBitmapDecoder.KEY_TARGET_FRAME, -5);
    new VideoBitmapDecoder().decode(resource, bitmapPool, 100, 100, options);
  }
  @Test public void testSpecifiesThumbnailFrameIfICalledWithFrameNumber() throws IOException {
    int frame = 5;
  ...
  @Test public void testDoesNotSpecifyThumbnailFrameIfCalledWithoutFrameNumber() throws IOException {
    decoder = new VideoBitmapDecoder(new VideoBitmapDecoder.MediaMetadataRetrieverFactory() {
        @Override public MediaMetadataRetriever build() {
          return factory.build();
        }
