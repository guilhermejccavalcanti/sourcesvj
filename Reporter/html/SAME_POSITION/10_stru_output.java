...
public class AmbryRequests implements RequestAPI {
  ...
  public AmbryRequests(StoreManager storeManager, RequestResponseChannel requestResponseChannel, ClusterMap clusterMap, DataNodeId nodeId, MetricRegistry registry) {
...
>>>>>>> C:\Users\user\Desktop\gjcc\amostra\projects\ambry\revisions\rev_2cb49af_4a6a7fc\rev_right_4a6a7fc\ambry-server\src\main\java\com.github.ambry.server\AmbryRequests.java
  ...
  private ServerErrorCode validateRequest(PartitionId partition, boolean checkPartitionState) {
    ...
    for (ReplicaId replica : replicaIds) 
      if (replica.getDataNodeId().getHostname() == currentNode.getHostname() && replica.getDataNodeId().getPort() == currentNode.getPort()) {
