...
public class DDLSemanticAnalyzer extends BaseSemanticAnalyzer {
  ...
  @Override public void analyzeInternal(ASTNode input) throws SemanticException {
    ASTNode ast = input;
    switch (ast.getType()){
    ...
    if (!alterPartitions) {
      ...
      if (isFullSpec(tab, partSpec)) {
        ...
        if (!AlterTableDesc.doesAlterTableTypeSupportPartialPartitionSpec(op)) {
          ...
          if (!conf.getBoolVar(HiveConf.ConfVars.DYNAMICPARTITIONING)) {
  ...
  static class QualifiedNameUtil {
    ...
    static public String getColPath(Hive db, ASTNode node, String dbName, String tableName, Map<String, String> partSpec) throws SemanticException {
    ...
    static public Map<String, String> getPartitionSpec(Hive db, ASTNode ast, String tableName) throws SemanticException {
